...
export default function ContactPage() {
  ...
  const waText = `Namaste ${displayInfo.shop_name || SITE.name}! Main ${form.fullname.trim()} (${form.contact.trim()}).\nService: ${form.service}\n${form.message.trim()}`;
            ...
            <div className="lg:col-span-5">
              <div className="rounded-3xl p-6 bg-white/[0.03] border border-white/[0.08]">
                ...
                <div className="space-y-3">
                  <a href={`tel:${displayInfo.phone?.replace(/\D/g, "")}`} className="flex items-start gap-3.5 rounded-2xl p-4 bg-white/[0.03] border border-white/[0.06] active:scale-[0.99] transition-transform">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-[14px] font-bold text-white mt-0.5">{displayInfo.phone || SITE.phone}</p>
                    </div>
                  </a>
                  <a href={`mailto:${displayInfo.email || SITE.email}`} className="flex items-start gap-3.5 rounded-2xl p-4 bg-white/[0.03] border border-white/[0.06] active:scale-[0.99] transition-transform">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-[14px] font-bold text-white mt-0.5 break-all">{displayInfo.email || SITE.email}</p>
                    </div>
                  </a>
                  <div className="flex items-start gap-3.5 rounded-2xl p-4 bg-white/[0.03] border border-white/[0.06]">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-[13px] text-slate-300 leading-relaxed mt-0.5">{displayInfo.address || SITE.address}</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3.5 rounded-2xl p-4 bg-white/[0.03] border border-white/[0.06]">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-[13px] font-bold text-white mt-0.5">{displayInfo.business_hours || "Mon–Sat · 9:00 AM – 8:00 PM"}</p>
                    </div>
                  </div>
                </div>
                ...
                {sent ? (
                  <div className="text-center py-10">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-3">
                      <a href={WHATSAPP_LINK(waText, displayInfo.whatsapp?.replace(/\D/g, ""))} target="_blank" rel="noopener noreferrer"
